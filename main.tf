...
locals {
  github-repo= "https://github.com/Nec2005/Swarm-phonebook-tf-project.git"
  github-file-url= "https://raw.githubusercontent.com/Nec2005/Swarm-phonebook-tf-project/master/"
}
